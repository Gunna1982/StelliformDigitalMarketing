    ...
    <div className="overflow-hidden relative py-6">
      ...
      >
        {doubled.map((tech, i) => (
          <span
            key={`${tech}-${i}`}
            className="inline-flex items-center gap-2 px-6 py-3 border border-white/[0.08] rounded-full text-sm tracking-wider uppercase"
...
export default function CaseStudyContent({ study }: { study: CaseStudy }) {
  ...
  return (
    <main className="min-h-screen text-white relative bg-[#070A10]">
      {/* Backdrop + grain (keep readable, not crushed) */}
      <SpaceBackdrop className="opacity-70" />
      <div
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-end overflow-hidden">
        ...
        {/* Decorative line */}
        <div
          className="absolute top-0 left-[15%] w-px h-full opacity-[0.06]"
          style={{ background: 'linear-gradient(to bottom, transparent, white 30%, white 70%, transparent)' }}
        />
        <div
          className="absolute top-0 right-[25%] w-px h-full opacity-[0.04]"
          style={{ background: 'linear-gradient(to bottom, transparent, white 40%, white 60%, transparent)' }}
        />
        ...
        <FadeSection>
          <div className="max-w-[1600px] mx-auto">
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(249,115,22,0.12) 0%, rgba(245,158,11,0.06) 50%, rgba(249,115,22,0.03) 100%)',
              ...
              {study.images?.[0] ? (
                <>
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(to top, rgba(0,0,0,0.55), rgba(0,0,0,0.15) 55%, rgba(0,0,0,0))',
                    }}
                  />
                </>
              ) : (
                <>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      <div className="w-24 h-24 rounded-full border border-white/[0.10] flex items-center justify-center">
                        <div className="w-3 h-3 rounded-full" style={{ background: 'rgba(249,115,22,0.5)' }} />
                      </div>
                      <div
      ...
      {/* ═══════ Challenge & Solution — Editorial Split ═══════ */}
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid md:grid-cols-12 gap-12 md:gap-8">
            ...
            <div className="hidden md:flex md:col-span-2 items-center justify-center">
              <div
                className="w-px h-full min-h-[200px] opacity-[0.06]"
      ...
      <section className="py-24 md:py-40 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 100% 80% at 50% 50%, rgba(249,115,22,0.04) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          {/* Metrics */}
          <div ref={resultsRef} className="grid md:grid-cols-3 gap-0">
            {study.results.map((result, index) => (
              ...
              >
                ...
                >
                  <AnimatedMetric value={result.metric} inView={resultsInView} />
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(249,115,22,0.04) 0%, transparent 70%)',
                  }}
                />
              </motion.div>
            ))}
      ...
      <section className="py-16 relative" style={{ borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
      ...
      <section className="py-32 md:py-48 px-6 md:px-12 relative">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(249,115,22,0.03) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="max-w-[1000px] mx-auto text-center relative">
          ...
          <FadeSection>
            <div
              className="text-[12rem] md:text-[16rem] leading-none font-serif absolute -top-20 left-1/2 -translate-x-1/2 select-none pointer-events-none"
              style={{
                color: 'transparent',
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid md:grid-cols-12 gap-4">
            <FadeSection className="md:col-span-7">
              <div
                className="relative aspect-[4/3] rounded-lg overflow-hidden"
                style={{
                  background:
                    'linear-gradient(135deg, rgba(249,115,22,0.10) 0%, rgba(245,158,11,0.05) 100%)',
                  border: '1px solid rgba(255,255,255,0.08)',
                }}
              >
                {study.images?.[1] ? (
                  <>
                    <Image src={study.images[1]} alt={`${study.title} screenshot 1`} fill className="object-cover" />
                    <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.45), transparent 60%)' }} />
                  </>
                ) : null}
              </div>
            </FadeSection>

            <FadeSection className="md:col-span-5" delay={0.15}>
              <div
                className="relative aspect-[4/3] rounded-lg overflow-hidden"
                style={{
                  background:
                    'linear-gradient(135deg, rgba(245,158,11,0.10) 0%, rgba(249,115,22,0.05) 100%)',
                  border: '1px solid rgba(255,255,255,0.08)',
                }}
              >
                {study.images?.[2] ? (
                  <>
                    <Image src={study.images[2]} alt={`${study.title} screenshot 2`} fill className="object-cover" />
                    <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.45), transparent 60%)' }} />
                  </>
                ) : null}
              </div>
      ...
      <section className="py-32 md:py-48 px-6 md:px-12 relative">
        <div
          ...
          style={{
            ...
            background:
              'linear-gradient(to bottom, rgba(249,115,22,0.02) 0%, transparent 40%)',
          }}
        />
        ...
        <div className="max-w-[1000px] mx-auto text-center relative">
          ...
          <RevealText>
            <h2
              className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-[-0.04em] mb-4"
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              Let&apos;s build
            </h2>
          ...
          <FadeSection delay={0.3}>
            <div className="mt-12">
              <Link
                href="/#contact"
                className="group inline-flex items-center gap-4 px-10 py-5 rounded-full text-sm uppercase tracking-[0.15em] font-medium transition-all duration-500 hover:gap-6"
                style={{
                  background: 'linear-gradient(135deg, #f97316, #f59e0b)',
                  color: '#050505',
                }}
